...
class Database
{
    ...
    public function insert($table, $params = array(), $finalDescription)
    {
        if ($this->tableExist($table)) {
            $POST_DATA = array();
            foreach ($params as $param_name => $param_val) {
                if ($param_val != $finalDescription) {
    ...
    public function update($table, $params = array(), $where = null, $finalDescription)
    {
        if ($this->tableExist($table)) {

            $args = array();
            foreach ($params as $key => $value) {
                if ($value != $finalDescription) {
    ...
    public function imageValidation($imgfile)
    {
